...
def upload_vehicle(request):
    ...
    Vehicle_company=request.POST.get('companyname','')
    ...
    if result_vehicle.exists():
        ...
        vehicle=Vehicle(Vehicle_model=Vehicle_model,Vehicle_company=Vehicle_company,
        Vehicle_type=Vehicle_type,Vehicle_fuel=Vehicle_fuel,
