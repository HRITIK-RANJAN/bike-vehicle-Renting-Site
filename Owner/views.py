...
def Vehicle_type_chart():
    vehicle = Vehicle.objects.all()
    fig = plt.figure(figsize =(10, 7))
    cruisers, sports_bike, adventure_bike, electric_bike, scooters, vintage_bikes, electric_scooters, other = 0, 0, 0, 0, 0, 0, 0, 0
    for v in vehicle:
        if v.Vehicle_type == 'Cruisers':
            cruisers += 1
        elif v.Vehicle_type == 'Sports bike':
            sports_bike += 1
        elif v.Vehicle_type == 'Adventure bike':
            adventure_bike += 1
        elif v.Vehicle_type == 'Electric bike':
            electric_bike += 1
        elif v.Vehicle_type == 'Scooters':
            scooters += 1
        elif v.Vehicle_type == 'Vintage bikes':
            vintage_bikes += 1
        elif v.Vehicle_type == 'Electric Scooters':
            electric_scooters += 1
        else:
            other += 1
    type = ['Cruisers','Sports bike', 'Adventure bike', 'Electric bike', 'Scooters', 'Vintage bikes', 'Electric Scooters', 'Other']
    data = [cruisers, sports_bike, adventure_bike, electric_bike, scooters, vintage_bikes, electric_scooters, other]
