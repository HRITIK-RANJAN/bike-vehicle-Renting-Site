...
def SendRequest_toOwner(request):
    ...
    RentVehicle_PickupLocation=request.POST.get('RentVehicle_PickupLocation','')
    RentVehicle_DropLocation=request.POST.get('RentVehicle_DropLocation','')
    ...
    rentvehicle = RentVehicle(RentVehicle_Date_of_Booking=RentVehicle_Date_of_Booking,
                              RentVehicle_PickupLocation=RentVehicle_PickupLocation,
                              RentVehicle_DropLocation = RentVehicle_DropLocation,
                            RentVehicle_Date_of_Return=RentVehicle_Date_of_Return,
                            Total_days=Total_days,
                            RentVehicle_Total_amount=RentVehicle_Total_amount,
